...
// Shown after a staff user's first magic link sign-in.
// They must set a permanent password before accessing the dashboard.
"use client"
  ...
  return (
    <div className="min-h-screen bg-[#0B1120] flex flex-col items-center justify-center px-4">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-400 text-sm">Staff Account Setup</p>
      </div>
